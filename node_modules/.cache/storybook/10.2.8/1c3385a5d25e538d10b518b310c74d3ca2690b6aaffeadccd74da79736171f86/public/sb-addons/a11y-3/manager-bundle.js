...
(() => {
  ...
  // node_modules/.cache/storybook/10.2.8/1c3385a5d25e538d10b518b310c74d3ca2690b6aaffeadccd74da79736171f86/sb-manager/a11y-3/manager-bundle.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();
  ...
  // node_modules/@storybook/addon-a11y/dist/_browser-chunks/chunk-4BE7D4DS.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();
  ...
  init_define_process_env();
  init_define_process_env_NODE_PATH();
  var ADDON_ID2 = "storybook/highlight", HIGHLIGHT = `${ADDON_ID2}/add`, REMOVE_HIGHLIGHT = `${ADDON_ID2}/remove`, RESET_HIGHLIGHT = `${ADDON_ID2}/reset`, SCROLL_INTO_VIEW = `${ADDON_ID2}/scroll-into-view`;
  ...
  var RuleType = {
    ...
    ...axeRuleMapping_experimental,
    ...axeRuleMapping_deprecated
  }, getTitleForAxeResult = (axeResult) => combinedRulesMap[axeResult.id]?.title || axeResult.id, getFriendlySummaryForAxeResult = (axeResult) => combinedRulesMap[axeResult.id]?.friendlySummary || axeResult.description, unhighlightedSelectors = ["html", "body", "main"], theme = convert(themes.light), colorsByType = {
  ...
  function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
    ...
    function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
      ...
      function Provider2(props) {
        let { scope, children, ...context } = props, Context = scope?.[scopeName][index] || BaseContext, value = useMemo(
          () => context,
  ...
  var $5e63c961fc1ce211$export$8c6ed5c666ac1360 = forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return createElement($5e63c961fc1ce211$var$SlotClone, _extends({}, slotProps, {
        ref: forwardedRef
      }), isValidElement(newElement) ? cloneElement(newElement, void 0, newChildren) : null);
    }
    return createElement($5e63c961fc1ce211$var$SlotClone, _extends({}, slotProps, {
      ref: forwardedRef
    }), children);
  ...
  function $e02a7d9cb1dc128c$export$c74125a8e3af6bb2(name) {
    let PROVIDER_NAME = name + "CollectionProvider", [createCollectionContext, createCollectionScope] = $c512c27ab02ef895$export$50c7b4e9d9f19c1(PROVIDER_NAME), [CollectionProviderImpl, useCollectionContext] = createCollectionContext(PROVIDER_NAME, {
      ...
      return react_default.createElement(CollectionProviderImpl, {
        scope,
        itemMap,
        collectionRef: ref
      }, children);
    ...
    let COLLECTION_SLOT_NAME = name + "CollectionSlot", CollectionSlot = react_default.forwardRef((props, forwardedRef) => {
      ...
      return react_default.createElement($5e63c961fc1ce211$export$8c6ed5c666ac1360, {
        ref: composedRefs
      }, children);
    });
    ...
    let ITEM_SLOT_NAME = name + "CollectionItemSlot", ITEM_DATA_ATTR = "data-radix-collection-item", CollectionItemSlot = react_default.forwardRef((props, forwardedRef) => {
      ...
      return react_default.useEffect(() => (context.itemMap.set(ref, {
        ref,
        ...itemData
      }), () => void context.itemMap.delete(ref))), react_default.createElement($5e63c961fc1ce211$export$8c6ed5c666ac1360, {
        [ITEM_DATA_ATTR]: "",
        ref: composedRefs
      }, children);
    });
  ...
  var $5e63c961fc1ce211$export$8c6ed5c666ac13602 = forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      let newElement = slottable.props.children, newChildren = childrenArray.map((child) => child === slottable ? Children.count(newElement) > 1 ? Children.only(null) : isValidElement(newElement) ? newElement.props.children : null : child);
      return createElement($5e63c961fc1ce211$var$SlotClone2, _extends({}, slotProps, {
        ref: forwardedRef
      }), isValidElement(newElement) ? cloneElement(newElement, void 0, newChildren) : null);
    }
    return createElement($5e63c961fc1ce211$var$SlotClone2, _extends({}, slotProps, {
  ...
  var $8927f6f2acc4f386$var$NODES = [
    ...
    let Node = forwardRef((props, forwardedRef) => {
      ...
      }, []), createElement(Comp, _extends({}, primitiveProps, {
        ref: forwardedRef
      }));
    });
  ...
  function $71cd76cc60e0454e$export$6f32135080cb4c3({ prop, defaultProp, onChange = () => {
    ...
    let [uncontrolledProp, setUncontrolledProp] = $71cd76cc60e0454e$var$useUncontrolledState({
      defaultProp,
      onChange
    }), isControlled = prop !== void 0, value1 = isControlled ? prop : uncontrolledProp, handleChange = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onChange), setValue = useCallback((nextValue) => {
      if (isControlled) {
  ...
  function $71cd76cc60e0454e$var$useUncontrolledState({ defaultProp, onChange }) {
    let uncontrolledState = useState(defaultProp), [value] = uncontrolledState, prevValueRef = useRef(value), handleChange = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onChange);
    return useEffect(() => {
  ...
  ]), [$d7bdfb9eb0fdf311$var$RovingFocusProvider, $d7bdfb9eb0fdf311$var$useRovingFocusContext] = $d7bdfb9eb0fdf311$var$createRovingFocusGroupContext($d7bdfb9eb0fdf311$var$GROUP_NAME), $d7bdfb9eb0fdf311$export$8699f7c8af148338 = forwardRef((props, forwardedRef) => createElement($d7bdfb9eb0fdf311$var$Collection.Provider, {
    scope: props.__scopeRovingFocusGroup
  }, createElement($d7bdfb9eb0fdf311$var$Collection.Slot, {
    scope: props.__scopeRovingFocusGroup
  }, createElement($d7bdfb9eb0fdf311$var$RovingFocusGroupImpl, _extends({}, props, {
    ref: forwardedRef
  })))));
  Object.assign($d7bdfb9eb0fdf311$export$8699f7c8af148338, {
    displayName: $d7bdfb9eb0fdf311$var$GROUP_NAME
  });
  var $d7bdfb9eb0fdf311$var$RovingFocusGroupImpl = forwardRef((props, forwardedRef) => {
    let { __scopeRovingFocusGroup, orientation, loop = !1, dir, currentTabStopId: currentTabStopIdProp, defaultCurrentTabStopId, onCurrentTabStopIdChange, onEntryFocus, ...groupProps } = props, ref = useRef(null), composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, ref), direction = $f631663db3294ace$export$b39126d51d94e6f3(dir), [currentTabStopId = null, setCurrentTabStopId] = $71cd76cc60e0454e$export$6f32135080cb4c3({
      prop: currentTabStopIdProp,
      defaultProp: defaultCurrentTabStopId,
      onChange: onCurrentTabStopIdChange
    }), [isTabbingBackOut, setIsTabbingBackOut] = useState(!1), handleEntryFocus = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onEntryFocus), getItems = $d7bdfb9eb0fdf311$var$useCollection(__scopeRovingFocusGroup), isClickFocusRef = useRef(!1), [focusableItemsCount, setFocusableItemsCount] = useState(0);
    return useEffect(() => {
    ...
    }, createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({
    ...
    ]), createElement($d7bdfb9eb0fdf311$var$Collection.ItemSlot, {
      scope: __scopeRovingFocusGroup,
      id,
      focusable,
      active
    }, createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends({
  ...
  var $921a889cee6df7e8$export$99c2b779aa4e8b8b = (props) => {
    ...
    }) : Children.only(children), ref = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(presence.ref, child.ref);
    return typeof children == "function" || presence.isPresent ? cloneElement(child, {
      ref
    }) : null;
  };
  $921a889cee6df7e8$export$99c2b779aa4e8b8b.displayName = "Presence";
  function $921a889cee6df7e8$var$usePresence(present) {
    let [node1, setNode] = useState(), stylesRef = useRef({}), prevPresentRef = useRef(present), prevAnimationNameRef = useRef("none"), initialState = present ? "mounted" : "unmounted", [state, send] = $fe963b355347cc68$export$3e6543de14f8614f(initialState, {
      mounted: {
        UNMOUNT: "unmounted",
    ...
    return useEffect(() => {
      ...
      if (node1) {
        let handleAnimationEnd = (event) => {
          ...
          event.target === node1 && isCurrentAnimation && flushSync(
            () => send("ANIMATION_END")
          );
  ...
  var $69cb30bb0017df05$var$TABS_NAME = "Tabs", [$69cb30bb0017df05$var$createTabsContext, $69cb30bb0017df05$export$355f5bd209d7b13a] = $c512c27ab02ef895$export$50c7b4e9d9f19c1($69cb30bb0017df05$var$TABS_NAME, [
  ...
  ]), $69cb30bb0017df05$var$useRovingFocusGroupScope = $d7bdfb9eb0fdf311$export$c7109489551a4f4(), [$69cb30bb0017df05$var$TabsProvider, $69cb30bb0017df05$var$useTabsContext] = $69cb30bb0017df05$var$createTabsContext($69cb30bb0017df05$var$TABS_NAME), $69cb30bb0017df05$export$b2539bed5023c21c = forwardRef((props, forwardedRef) => {
    ...
    return createElement($69cb30bb0017df05$var$TabsProvider, {
      scope: __scopeTabs,
  ...
  var $69cb30bb0017df05$var$TAB_LIST_NAME = "TabsList", $69cb30bb0017df05$export$9712d22edc0d78c1 = forwardRef((props, forwardedRef) => {
    ...
    return createElement($d7bdfb9eb0fdf311$export$be92b6f5f03c0fe9, _extends({
      asChild: !0
  ...
  var $69cb30bb0017df05$var$TRIGGER_NAME = "TabsTrigger", $69cb30bb0017df05$export$8114b9fdfdf9f3ba = forwardRef((props, forwardedRef) => {
    ...
    return createElement($d7bdfb9eb0fdf311$export$6d08773d2e66f8f2, _extends({
      asChild: !0
    }, rovingFocusGroupScope, {
      focusable: !disabled,
      active: isSelected
    }), createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.button, _extends({
      type: "button",
      role: "tab",
  ...
  var $69cb30bb0017df05$var$CONTENT_NAME = "TabsContent", $69cb30bb0017df05$export$bd905d70e8fd2ebb = forwardRef((props, forwardedRef) => {
    ...
    return useEffect(() => {
      ...
      ({ present }) => createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
        role: "tabpanel",
  ...
  var $69cb30bb0017df05$export$be92b6f5f03c0fe9 = $69cb30bb0017df05$export$b2539bed5023c21c, $69cb30bb0017df05$export$54c2e3dc7acea9f5 = $69cb30bb0017df05$export$9712d22edc0d78c1, $69cb30bb0017df05$export$41fb9f06171c75f4 = $69cb30bb0017df05$export$8114b9fdfdf9f3ba, $69cb30bb0017df05$export$7c6e2c02157bb7d2 = $69cb30bb0017df05$export$bd905d70e8fd2ebb, StyledSyntaxHighlighter = styled(SyntaxHighlighter)(
    ({ theme: theme2 }) => ({
    ...
    return react_default.createElement(Button, { ariaLabel: !1, onClick: handleClick }, copied ? react_default.createElement(CheckIcon, null) : react_default.createElement(CopyIcon, null), " ", copied ? "Copied" : "Copy link");
  }, Details = ({ id, item, type, selection, handleSelectionChange }) => react_default.createElement(Wrapper, { id }, react_default.createElement(Info, null, react_default.createElement(RuleId, null, item.id), react_default.createElement(Description, null, getFriendlySummaryForAxeResult(item), " ", react_default.createElement(Link, { href: item.helpUrl, target: "_blank", rel: "noopener noreferrer", withArrow: !0 }, "Learn how to resolve this violation"))), react_default.createElement(
    ...
    react_default.createElement(Columns, null, react_default.createElement($69cb30bb0017df05$export$54c2e3dc7acea9f5, { "aria-label": type }, item.nodes.map((node, index) => {
      let key = `${type}.${item.id}.${index + 1}`;
      return react_default.createElement(Fragment, { key }, react_default.createElement($69cb30bb0017df05$export$41fb9f06171c75f4, { value: key, asChild: !0 }, react_default.createElement(Item, { ariaLabel: !1, variant: "ghost", size: "medium", id: key }, index + 1, ". ", node.html)), react_default.createElement($69cb30bb0017df05$export$7c6e2c02157bb7d2, { value: key, asChild: !0 }, react_default.createElement(Content, { side: "left" }, getContent(node))));
...
${target} {}`
  ...
  var impactStatus = {
    ...
    serious: "Serious",
    critical: "Critical"
  }, Wrapper2 = styled.div(({ theme: theme2 }) => ({
    display: "flex",
    flexDirection: "column",
    width: "100%",
  ...
  })), Icon = styled(ChevronSmallDownIcon)({
    transition: "transform 0.1s ease-in-out"
  }), HeaderBar = styled.div(({ theme: theme2 }) => ({
    display: "flex",
  ...
  })), Title = styled.div(({ theme: theme2 }) => ({
    display: "flex",
    alignItems: "baseline",
    flexGrow: 1,
    fontSize: theme2.typography.size.s2,
    gap: 8
  })), RuleId2 = styled.div(({ theme: theme2 }) => ({
    display: "none",
    color: theme2.textMutedColor,
    fontFamily: theme2.typography.fonts.mono,
    fontSize: theme2.typography.size.s1,
    ...
    selectedItems,
    toggleOpen
  }) => react_default.createElement(react_default.Fragment, null, items && items.length ? items.map((item) => {
    ...
    return react_default.createElement(Wrapper2, { key: id }, react_default.createElement(HeaderBar, { onClick: (event) => toggleOpen(event, type, item), "data-active": !!selection }, react_default.createElement(Title, null, react_default.createElement("strong", null, title), react_default.createElement(RuleId2, null, item.id)), item.impact && react_default.createElement(Badge, { status: type === RuleType.PASS ? "neutral" : impactStatus[item.impact] }, impactLabels[item.impact]), react_default.createElement(Count, null, item.nodes.length), react_default.createElement(
      ...
      react_default.createElement(Icon, { style: { transform: `rotate(${selection ? -180 : 0}deg)` } })
    )), selection ? react_default.createElement(
      Details,
      {
        id: detailsId,
        item,
    ...
    ) : react_default.createElement("div", { id: detailsId }));
  }) : react_default.createElement(EmptyTabContent, { title: empty })), Container = styled.div({
    width: "100%",
    position: "relative",
    height: "100%",
    overflow: "hidden",
    ...
    return createElement(Container, null, createElement(
      TabsView,
      {
        ...
        tools: createElement(ActionsWrapper, null, createElement(
          Button,
          {
            variant: "ghost",
            padding: "small",
          ...
          highlighted ? createElement(EyeCloseIcon, null) : createElement(EyeIcon, null)
        ), createElement(
          Button,
          {
            variant: "ghost",
          ...
          allExpanded ? createElement(CollapseIcon, null) : createElement(ExpandAltIcon, null)
        ), createElement(
          Button,
          {
            variant: "ghost",
          ...
          createElement(SyncIcon, null)
        ))
      }
    ));
  }, Wrapper3 = styled.div(({ theme: { color: color2, typography: typography2, background: background2 } }) => ({
    textAlign: "start",
    padding: "11px 15px",
    fontSize: `${typography2.size.s2}px`,
    ...
    position: "relative",
    code: {
      fontSize: `${typography2.size.s1 - 1}px`,
      color: "inherit",
      margin: "0 0.2em",
      padding: "0 0.2em",
  ...
  }, RotatingIcon = styled(SyncIcon)(({ theme: theme2 }) => ({
    ...
    alignItems: "center",
    gap: 6
  }), Centered = styled.span(({ theme: theme2 }) => ({
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
    justifyContent: "center",
    ...
    let {
      ...
      return [
        {
          label: react_default.createElement(Tab, null, "Violations", react_default.createElement(Badge, { compact: !0, status: tab === "violations" ? "active" : "neutral" }, violations.length)),
          panel: react_default.createElement(
            Report,
            {
              items: violations,
        ...
        {
          label: react_default.createElement(Tab, null, "Passes", react_default.createElement(Badge, { compact: !0, status: tab === "passes" ? "active" : "neutral" }, passes.length)),
          panel: react_default.createElement(
            Report,
            {
              items: passes,
        ...
        {
          label: react_default.createElement(Tab, null, "Inconclusive", react_default.createElement(Badge, { compact: !0, status: tab === "incomplete" ? "active" : "neutral" }, incomplete.length)),
          panel: react_default.createElement(
            Report,
            {
              items: incomplete,
    ...
    let [globals, updateGlobals, storyGlobals] = useGlobals(), value = globals[VISION_GLOBAL_KEY], isLocked = storyGlobals[VISION_GLOBAL_KEY] !== void 0, options = Object.entries(filters).map(([key, { label, percentage }]) => ({
      title: label,
      description: percentage ? `${percentage}% of users` : void 0,
      icon: react_default.createElement(ColorIcon, { $filter: key }),
      value: key
    }));
    return react_default.createElement(react_default.Fragment, null, react_default.createElement(
      Select,
      {
        ...
        icon: react_default.createElement(AccessibilityIcon, null),
        disabled: isLocked,
    ...
    ), react_default.createElement(Hidden, { dangerouslySetInnerHTML: { __html: filterDefs } }));
  }, Title2 = () => {
    let selectedPanel = useStorybookApi().getSelectedPanel(), [{ results }] = useAddonState(ADDON_ID, {
      ui: {
        highlighted: !1,
        tab: RuleType.VIOLATION
      },
      ...
      error: void 0,
      status: "initial"
    }), violationsNb = results?.violations?.length ?? 0, incompleteNb = results?.incomplete?.length ?? 0, count = violationsNb + incompleteNb, suffix = count === 0 ? null : react_default.createElement(Badge, { compact: !0, status: selectedPanel === PANEL_ID ? "active" : "neutral" }, count);
    return react_default.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, react_default.createElement("span", null, "Accessibility"), suffix);
  };
  addons.register(ADDON_ID, (api) => {
    addons.add(PANEL_ID, {
      ...
      render: () => react_default.createElement(VisionSimulator, null)
    }), addons.add(PANEL_ID, {
      title: Title2,
      type: types.PANEL,
      render: ({ active = !0 }) => react_default.createElement(A11yContextProvider, null, active ? react_default.createElement(A11YPanel, null) : null),
      paramKey: PARAM_KEY
    });
  });
})();
