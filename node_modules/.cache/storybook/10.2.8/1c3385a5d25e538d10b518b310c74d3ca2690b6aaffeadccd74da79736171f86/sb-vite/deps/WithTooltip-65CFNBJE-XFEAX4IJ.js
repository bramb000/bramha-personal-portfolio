...
// node_modules/storybook/dist/_browser-chunks/WithTooltip-65CFNBJE.js
...
var TargetContainer = styled.div`
  ...
  cursor: ${(props) => {
  var _a;
  return props.trigger === "hover" || ((_a = props.trigger) == null ? void 0 : _a.includes("hover")) ? "default" : "pointer";
}};
`;
...
var WithTooltipPure = ({
  ...
  let Container = svg ? TargetSvgContainer : TargetContainer, {
    ...
    Tooltip,
    {
      placement: state == null ? void 0 : state.placement,
      ref: setTooltipRef,
      hasChrome,
...
//# sourceMappingURL=WithTooltip-65CFNBJE-XFEAX4IJ.js.map
