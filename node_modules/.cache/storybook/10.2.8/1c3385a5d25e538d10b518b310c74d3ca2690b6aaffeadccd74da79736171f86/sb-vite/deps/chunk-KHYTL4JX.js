...
import {
  require_jsx_runtime
} from "./chunk-KWFSDQBC.js";
import {
  require_global
} from "./chunk-OEK2TTOV.js";
import {
  require_react_dom
} from "./chunk-D2PUM7Q3.js";
import {
  require_react
...
var Primitive = NODES.reduce((primitive, node) => {
  let Node = React4.forwardRef((props, forwardedRef) => {
    ...
    return typeof window < "u" && (window[Symbol.for("radix-ui")] = true), (0, import_jsx_runtime2.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext3(rootComponentName, defaultContext) {
    ...
    function Provider(props) {
      let { scope, children, ...context } = props, Context = (scope == null ? void 0 : scope[scopeName][index]) || BaseContext, value = React7.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime3.jsx)(Context.Provider, { value, children });
    }
    function useContext22(consumerName, scope) {
      let Context = (scope == null ? void 0 : scope[scopeName][index]) || BaseContext, context = React7.useContext(Context);
...
function composeEventHandlers(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
  return function(event) {
    if (originalEventHandler == null ? void 0 : originalEventHandler(event), checkForDefaultPrevented === false || !event.defaultPrevented)
...
var ScrollAreaCornerImpl = React23.forwardRef((props, forwardedRef) => {
  ...
  return useResizeObserver(context.scrollbarX, () => {
    var _a;
    let height2 = ((_a = context.scrollbarX) == null ? void 0 : _a.offsetHeight) || 0;
    context.onCornerHeightChange(height2), setHeight(height2);
  }), useResizeObserver(context.scrollbarY, () => {
    var _a;
    let width2 = ((_a = context.scrollbarY) == null ? void 0 : _a.offsetWidth) || 0;
...
async function copyUsingClipboardAPI(text) {
  var _a;
  try {
    await ((_a = globalWindow.top) == null ? void 0 : _a.navigator.clipboard.writeText(text));
  } catch {
...
function createCopyToClipboardFunction() {
  var _a;
  return ((_a = globalWindow.navigator) == null ? void 0 : _a.clipboard) ? copyUsingClipboardAPI : copyUsingWorkAround;
}
...
//# sourceMappingURL=chunk-KHYTL4JX.js.map
