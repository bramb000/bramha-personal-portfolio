...
import "./chunk-KHYTL4JX.js";
import "./chunk-JRKUMY2M.js";
import {
  styled
} from "./chunk-4B4RCI5P.js";
import "./chunk-JETXBADP.js";
import "./chunk-Z37X6M5Y.js";
import "./chunk-LKLX6Y35.js";
import "./chunk-F6NJIY5Q.js";
import "./chunk-KWFSDQBC.js";
import "./chunk-CS5B2F7V.js";
import "./chunk-3GDBKHOW.js";
import "./chunk-OEK2TTOV.js";
import "./chunk-J2ZMUCCT.js";
import "./chunk-CYGNCWV3.js";
import "./chunk-LSSTZXLL.js";
import "./chunk-D2PUM7Q3.js";
import {
  require_react
...
// node_modules/@storybook/addon-docs/dist/_browser-chunks/Color-6BZIO3FS.js
...
var usePresets = (presetColors, currentColor, colorSpace) => {
  ...
  let presets = (0, import_react.useMemo)(() => (presetColors || []).map((preset) => typeof preset == "string" ? parseValue(preset) : preset.title ? { ...parseValue(preset.color), keyword: preset.title } : parseValue(preset.color)).concat(selectedColors).filter(Boolean).slice(-27), [presetColors, selectedColors]), addPreset = (0, import_react.useCallback)(
    (color) => {
      (color == null ? void 0 : color.valid) && (presets.some(
...
var ColorControl = ({
  ...
  let debouncedOnChange = (0, import_react.useCallback)(debounce(onChange, 200), [onChange]), { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(
    initialValue,
    debouncedOnChange
  ), { presets, addPreset } = usePresets(presetColors ?? [], color, colorSpace), Picker = ColorPicker[colorSpace], readOnly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), controlId = getControlId(name);
  return import_react.default.createElement(Wrapper, null, import_react.default.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), import_react.default.createElement(
    ...
    PopoverProvider,
    {
      ...
      popover: import_react.default.createElement(TooltipContent, null, import_react.default.createElement(
        ...
        SwatchColor,
        {
          key: `${(preset == null ? void 0 : preset.value) || index}-${index}`,
          variant: "ghost",
          padding: "small",
          size: "small",
          ariaLabel: "Pick this color",
          tooltip: (preset == null ? void 0 : preset.keyword) || (preset == null ? void 0 : preset.value) || "",
          value: (preset == null ? void 0 : preset.value) || "",
...
//# sourceMappingURL=Color-6BZIO3FS-Z4FWWB5F.js.map
